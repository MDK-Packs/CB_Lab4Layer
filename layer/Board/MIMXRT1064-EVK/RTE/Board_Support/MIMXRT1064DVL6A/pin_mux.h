...
#define BOARD_INITENETPINS_IOMUXC_GPR_GPR26_GPIO_MUX1_GPIO_SEL_MASK 0x0400U /*!< GPIO1 and GPIO6 share same IO MUX function, GPIO_MUX1 selects one GPIO function: affected bits mask */
...
/* GPIO_AD_B1_06 (coord J12), CSI_VSYNC/J35[18]/J22[2]/UART_TX */
/* Routed pin properties */
#define BOARD_INITARDUINO_UARTPINS_CSI_VSYNC_PERIPHERAL                  LPUART3   /*!< Peripheral name */
#define BOARD_INITARDUINO_UARTPINS_CSI_VSYNC_SIGNAL                           TX   /*!< Signal name */

/* GPIO_AD_B1_07 (coord K10), CSI_HSYNC/J35[16]/J22[1]/UART_RX */
/* Routed pin properties */
#define BOARD_INITARDUINO_UARTPINS_CSI_HSYNC_PERIPHERAL                  LPUART3   /*!< Peripheral name */
#define BOARD_INITARDUINO_UARTPINS_CSI_HSYNC_SIGNAL                           RX   /*!< Signal name */
...
#define BOARD_INITAUDIOPINS_IOMUXC_GPR_GPR26_GPIO_MUX1_GPIO_SEL_MASK 0x01000000U /*!< GPIO1 and GPIO6 share same IO MUX function, GPIO_MUX1 selects one GPIO function: affected bits mask */

/* GPIO_AD_B1_08 (coord H13), AUD_INT/CSI_D9//J35[13]/J22[4] */
/* Routed pin properties */
#define BOARD_INITAUDIOPINS_CSI_D9_PERIPHERAL                              GPIO1   /*!< Peripheral name */
#define BOARD_INITAUDIOPINS_CSI_D9_SIGNAL                                gpio_io   /*!< Signal name */
#define BOARD_INITAUDIOPINS_CSI_D9_CHANNEL                                   24U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITAUDIOPINS_CSI_D9_GPIO                                    GPIO1   /*!< GPIO peripheral base pointer */
#define BOARD_INITAUDIOPINS_CSI_D9_GPIO_PIN                                  24U   /*!< GPIO pin number */
#define BOARD_INITAUDIOPINS_CSI_D9_GPIO_PIN_MASK                     (1U << 24U)   /*!< GPIO pin mask */
#define BOARD_INITAUDIOPINS_CSI_D9_PORT                                    GPIO1   /*!< PORT peripheral base pointer */
#define BOARD_INITAUDIOPINS_CSI_D9_PIN                                       24U   /*!< PORT pin number */
#define BOARD_INITAUDIOPINS_CSI_D9_PIN_MASK                          (1U << 24U)   /*!< PORT pin mask */

/* GPIO_AD_B1_09 (coord M13), SAI1_MCLK/CSI_D8/J35[11] */
/* Routed pin properties */
#define BOARD_INITAUDIOPINS_CSI_D8_PERIPHERAL                               SAI1   /*!< Peripheral name */
#define BOARD_INITAUDIOPINS_CSI_D8_SIGNAL                               sai_mclk   /*!< Signal name */

/* GPIO_AD_B1_12 (coord H12), SAI1_RXD/CSI_D5/J35[5]/U13[16] */
/* Routed pin properties */
#define BOARD_INITAUDIOPINS_CSI_D5_PERIPHERAL                               SAI1   /*!< Peripheral name */
#define BOARD_INITAUDIOPINS_CSI_D5_SIGNAL                           sai_rx_data0   /*!< Signal name */

/* GPIO_AD_B1_13 (coord H11), SAI1_TXD/CSI_D4/J35[3]/U13[14] */
/* Routed pin properties */
#define BOARD_INITAUDIOPINS_CSI_D4_PERIPHERAL                               SAI1   /*!< Peripheral name */
#define BOARD_INITAUDIOPINS_CSI_D4_SIGNAL                           sai_tx_data0   /*!< Signal name */

/* GPIO_AD_B1_14 (coord G12), SAI1_TX_BCLK/CSI_D3/J35[4]/U13[12] */
/* Routed pin properties */
#define BOARD_INITAUDIOPINS_CSI_D3_PERIPHERAL                               SAI1   /*!< Peripheral name */
#define BOARD_INITAUDIOPINS_CSI_D3_SIGNAL                            sai_tx_bclk   /*!< Signal name */

/* GPIO_AD_B1_15 (coord J14), SAI1_TX_SYNC/CSI_D2/J35[6]/U13[13] */
/* Routed pin properties */
#define BOARD_INITAUDIOPINS_CSI_D2_PERIPHERAL                               SAI1   /*!< Peripheral name */
#define BOARD_INITAUDIOPINS_CSI_D2_SIGNAL                            sai_tx_sync   /*!< Signal name */
...
/* Routed pin properties */
#define BOARD_INITBUTTONSPINS_USER_BUTTON_PERIPHERAL                       GPIO5   /*!< Peripheral name */
#define BOARD_INITBUTTONSPINS_USER_BUTTON_SIGNAL                         gpio_io   /*!< Signal name */
#define BOARD_INITBUTTONSPINS_USER_BUTTON_CHANNEL                             0U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITBUTTONSPINS_USER_BUTTON_GPIO                             GPIO5   /*!< GPIO peripheral base pointer */
#define BOARD_INITBUTTONSPINS_USER_BUTTON_GPIO_PIN                            0U   /*!< GPIO pin number */
#define BOARD_INITBUTTONSPINS_USER_BUTTON_GPIO_PIN_MASK               (1U << 0U)   /*!< GPIO pin mask */
#define BOARD_INITBUTTONSPINS_USER_BUTTON_PORT                             GPIO5   /*!< PORT peripheral base pointer */
#define BOARD_INITBUTTONSPINS_USER_BUTTON_PIN                                 0U   /*!< PORT pin number */
#define BOARD_INITBUTTONSPINS_USER_BUTTON_PIN_MASK                    (1U << 0U)   /*!< PORT pin mask */
...
#define BOARD_INITLEDPINS_IOMUXC_GPR_GPR26_GPIO_MUX1_GPIO_SEL_MASK 0x0200U /*!< GPIO1 and GPIO6 share same IO MUX function, GPIO_MUX1 selects one GPIO function: affected bits mask */

/* GPIO_AD_B0_09 (coord F14), JTAG_TDI/J21[5]/ENET_RST/J22[5] */
/* Routed pin properties */
#define BOARD_INITLEDPINS_USER_LED_PERIPHERAL                              GPIO1   /*!< Peripheral name */
#define BOARD_INITLEDPINS_USER_LED_SIGNAL                                gpio_io   /*!< Signal name */
#define BOARD_INITLEDPINS_USER_LED_CHANNEL                                    9U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITLEDPINS_USER_LED_GPIO                                    GPIO1   /*!< GPIO peripheral base pointer */
#define BOARD_INITLEDPINS_USER_LED_GPIO_PIN                                   9U   /*!< GPIO pin number */
#define BOARD_INITLEDPINS_USER_LED_GPIO_PIN_MASK                      (1U << 9U)   /*!< GPIO pin mask */
#define BOARD_INITLEDPINS_USER_LED_PORT                                    GPIO1   /*!< PORT peripheral base pointer */
#define BOARD_INITLEDPINS_USER_LED_PIN                                        9U   /*!< PORT pin number */
#define BOARD_INITLEDPINS_USER_LED_PIN_MASK                           (1U << 9U)   /*!< PORT pin mask */
